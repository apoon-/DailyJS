...
var labels = [
        "Wait, you don't know how to make that, so just learn JavaScript",
        "That breaches a load of fucking copyrights, so just learn JavaScript",
        "No one will fucking use that, so just learn JavaScript",
        "That's not going to fucking work, so just learn JavaScript",
        "Does not fucking compute dumbass, so just learn JavaScript"
];
/*
